			...
			{?>
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <!--<div class="form-group">
                              <label>Candidate Name</label>
                                <input readonly class="form-control input-md" value="" name="candidate_name" type="text" placeholder="Name">
                            </div>-->
			    <div class="form-group">
                              <label>Candidate Name</label>
			    ...
			    <div class="form-group">
                              <label>Middle Name</label>
                                <input readonly class="form-control input-md" value="<?php echo $employeeEdit[0]['middle_name'];?>" name="middle_name" type="text" placeholder="Middle Name">
                            </div>
			    <div class="form-group">
                              <label>Last Name</label>
                                <input readonly class="form-control input-md" value="<?php echo $employeeEdit[0]['last_name'];?>" name="last_name" type="text" placeholder="Last Name">
                            </div>
                            <div class="form-group">
				    ...
				    <?php foreach($years as $years){?>
                                    <option value="<?php echo $years;?>" <?php if($employeeEdit[0]['total_exp_year']==$years) echo "selected"?>><?php echo $years;?></option>
                                  <?php }?>
				  </select>
                                </div>
                                 <div class="form-group col-md-4">
			    ...
			    <div class="">
                                ...
                                <div class="row">
				  <div class="form-group col-md-4">
				    <?php $currentCTC=array('100000','200000','300000','400000','500000','600000','700000','800000') ?> 
				    <select disabled name="current_ctc" class="form-control">
				    <?php foreach($currentCTC as $currentCTC){?>
				       <option value="<?php echo $currentCTC;?>" <?php if($employeeEdit[0]['current_ctc']==$currentCTC) echo "selected"?>><?php echo $currentCTC;?></option>
                                    <?php }?>
				     </select>
				  </div>
				</div>
			    ...
			    <div class="">
                                ...
                                <div class="row">
				  <div class="form-group col-md-4">
				    <?php $expCTC=array('100000','200000','300000','400000','500000','600000','700000','800000') ?> 
				    <select disabled name="expected_ctc" class="form-control">
				    <?php foreach($expCTC as $expCTC){?>
				       <option value="<?php echo $expCTC;?>" <?php if($employeeEdit[0]['expected_ctc']==$expCTC) echo "selected"?>><?php echo $expCTC;?></option>
                                    <?php }?>
				     </select>
				  </div>
				</div>
				    ...
				    <?php  $year=array('1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016') ?> 
                            ...
                            <div class="form-group">
                              <label>Pan Card Number <span style="color:#EB8B11">*</span></label>
                                <input readonly class="form-control input-md" value="<?php echo $employeeEdit[0]['pan_card_no'];?>" name="pan_card_no" type="text" placeholder="Please Enter Your Pan Card Number">
                            </div>
                            <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-md" readonly value="<?php echo $employeeEdit[0]['educational_gap_year'];?>" name="educational_gap_year" type="text" placeholder="Educational Gap(in years)">
                            </div>
                            <div class="form-group">
                                <label>Carrier Gap(in years)</label>
                                <input readonly class="form-control input-md" value="<?php echo $employeeEdit[0]['career_gap_year'];?>" name="career_gap_year" type="text" placeholder="Email">
                            </div>
