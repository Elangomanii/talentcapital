...
<div class="container" style="padding-top: 80px;padding-bottom: 40px;">
    ...
    <form id="form_validation" method="post" action="" enctype="multipart/form-data" role="form">
	    ...
	    <div class="form-group">
            ...
            <div class="form-group">
                <label>Name</label>
                <input class="form-control input-md" data-toggle="tooltip" value="<?php echo $getVendorDetails[0]['name']?>" data-trigger="manual" data-title="Caps lock is on"  name="name" type="text" placeholder="Name">
            </div>
	    
            <div class="form-group">
                <label>Mobile Number <span style="color:#EB8B11">*</span> </label>
                <input class="form-control input-md" value="<?php echo $getVendorDetails[0]['mobile_number']?>" name="mobile_number" type="text" placeholder="Number">
            </div>
            <div class="form-group">
