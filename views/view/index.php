...
#register-form{
    ...
    <!--<div style="margin-top:5%;position: fixed;margin-left:95%;">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-login">
						...
						<select name="login_types" class="form-control input-lg">
						    ...
						    <option value="vendor">Hiring Partner</option>
						    <option value="directemploye">Direct Employee</option>
					...
					<div class="form-group">
					    <center>
					    <a href="<?php echo site_url('talentcapitalctr/forgetPassword');?>">Forgot Your Password ?</a>
					    </center>
					</div>
                                    </form>
